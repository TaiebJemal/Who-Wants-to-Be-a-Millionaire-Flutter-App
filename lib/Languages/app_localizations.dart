...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'app_title': 'Quizy',
      'about_title': 'About',
      'about_description': 'Quizy is a sophisticated Flutter-based quiz application that leverages the Open Trivia Database API to deliver an engaging trivia experience. Developed by Chedy Chaaben and Taieb Jemal, second-year Software Engineering students at the International Institute of Technology (IIT Sfax), this application showcases their technical skills and understanding of modern mobile development principles.',
      'quiz_title': 'Quiz',
    ...
    'fr': {
      ...
      'about_description': 'Quizy est une application de quiz sophistiquée développée avec Flutter qui utilise lAPI Open Trivia Database pour offrir une expérience de trivia captivante. Conçue par Chedy Chaaben et Taieb Jemal, étudiants en deuxième année de Génie Logiciel à l Institut International de Technologie de Sfax (IIT Sfax), cette application démontre leurs compétences techniques et leur maîtrise des principes modernes de développement mobile.',
      'quiz_title': 'Quiz',
      'question_label': 'Question',
      'name': 'Nom',
      'time_label': 'Temps',
    ...
    'ar': {
      ...
      'about_title': 'حول',
      'about_description': 'كويزي هو تطبيق مسابقات متطور تم تطويره باستخدام إطار عمل فلاتر، ويعتمد على واجهة برمجة التطبيقات لقاعدة بيانات التريفيا المفتوحة لتقديم تجربة مسابققات شيقة. تم تصميمه بواسطة شادي الشعبان والطيب الجمال، طلاب السنة الثانية في هندسة البرمجيات بالمعهد الدولي للتكنولوجيا بصفاقس، ويبرهن هذا التطبيق على مهاراتهما التقنية وفهمهما لمبادئ تطوير التطبيقات الحديثة.',
      'quiz_title': 'اختبار',
  ...
  String get language => _localizedValues[locale.languageCode]?['language'] ?? 'Languages';
